...
//Event listener para los events de busqueda
...
function mostrarAutos(autos) {
    ...
    autos.forEach(auto => {
        ...
        //Crear un parrafo para cada auto
        const autoHTML = document.createElement('P');

        autoHTML.textContent = `
            ${marca} ${modelo} - ${year} - Precio: ${precio} - Color: ${color} - Transmision: ${transmision} - Puertas: ${puertas}
